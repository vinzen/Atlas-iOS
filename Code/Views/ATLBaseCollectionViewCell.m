...
- (void)prepareForReuse
{
    ...
    self.bubbleViewWidthConstraint.constant = self.maxBubbleWidth;
}
...
- (void)configureLayoutConstraints
{
    ...
    self.bubbleViewWidthConstraint = [NSLayoutConstraint constraintWithItem:self.bubbleView attribute:NSLayoutAttributeWidth relatedBy:NSLayoutRelationLessThanOrEqual toItem:nil attribute:NSLayoutAttributeNotAnAttribute multiplier:1.0 constant:self.maxBubbleWidth];
    [self.contentView addConstraint:self.bubbleViewWidthConstraint];
